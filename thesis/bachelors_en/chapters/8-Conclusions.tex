...
This thesis examined NISQ-oriented structural optimization of FRQI state preparation for a fixed QHED edge-detection downstream stage. The work is entirely \textbf{simulator-based}, using open Python tooling and versioned CSV manifests. Beyond the headline resource win for v-chain, the project contributes a \textbf{transparent evaluation recipe}---resources, noisy-state fidelity, and edge-map SSIM on the same grid---so that synthesis trade-offs in QIP pipelines can be discussed without conflating transpiler CX with perceptual endpoints.

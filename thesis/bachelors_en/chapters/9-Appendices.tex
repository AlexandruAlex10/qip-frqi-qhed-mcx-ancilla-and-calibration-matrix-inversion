...
\centering
\footnotesize
\caption{Noisy reconstruction edge SSIM (naive vs v-chain) for smaller test images.\label{tab:noisy-long}}
...
\begin{table}[htbp]
\centering
\caption{Structural FRQI preparation metrics (transpiled, optimization level~3, unconstrained topology).\label{tab:struct-csv}}
\scriptsize
...
\chapter{Simulator wall-clock excerpt ($4\times4$ and $8\times8$)}
